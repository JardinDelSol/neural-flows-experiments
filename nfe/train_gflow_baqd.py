...
parser.add_argument(
    ...
    type=str,
    default="flow",
    help="Whether to use ODE or flow based model or RNN",
...
parser.add_argument(
    "--weight-decay", type=float, default=0.0001, help="Weight decay (regularization)"
)
parser.add_argument(
    "--lr-scheduler-step",
    type=int,
...
parser.add_argument(
    ...
    type=int,
    default=0,
    help="Include classification loss (physionet and activity)",
    choices=[0, 1],
)
parser.add_argument(
    "--extrap",
    type=int,
    default=0,
    help="Set extrapolation mode. Else run interpolation mode.",
    choices=[0, 1],
)
parser.add_argument(
    "-n", type=int, default=10000, help="Size of the dataset (latent_ode)"
)
parser.add_argument(
    "--quantization",
    type=float,
